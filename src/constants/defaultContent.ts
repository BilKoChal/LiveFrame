...
/**
 * Default content for the three built-in files (HTML, CSS, JS).
 *
 * Single source of truth — import from here instead of duplicating
 * across stores or components.
 */

export const DEFAULT_HTML = `<!-- LiveFrame Preview Canvas -->
<div class="card">
  <h1>LiveFrame</h1>
...
export const DEFAULT_CSS = `/* Custom modern slate styling */
body {
...
export const DEFAULT_JS = `// Interactive LiveFrame Scripting
